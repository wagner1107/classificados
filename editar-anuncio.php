...
<?php
	...
	if(isset($_POST['titulo']) && !empty($_POST['titulo'])){
		...
		if(isset($_FILES['fotos'])){ // tava $_FOTOS, e o correto é $_FILES hehe
			$fotos = $_FILES['fotos'];
		} else {
			$fotos = array();
		}
...
?>
<div class="container">
	<h1>Meus Anúncios <small>Editar anúncio</small></h1>
	...
	<form method="POST" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="text" name="preco" id="preco" class="form-control" value="<?php echo $info['preco'] ?>" />
		</div>
		...
		<div class="form-group">
			...
			<select name="estado" id="estado" class="form-control">
				...
				<option value="1" <?php echo ($info['estado'] == '1')?'selected="selected"':''; ?>>Em bom estado</option>
