				...
				<form method="GET">
					...
					<div class="form-group">
						...
						<select id="preco" name="filtros[preco]" class="form-control">
							...
							<option value="101-150"<?php echo($filtros['preco']=='101-150')?'selected="selected"':''; ?>>R$ 101 - 150</option>
							<option value="151-500"<?php echo($filtros['preco']=='151-500')?'selected="selected"':''; ?>>R$ 151 - 500</option>
						</select>
					</div>
					...
					<div class="form-group">
						...
						<select id="estado" name="filtros[estado]" class="form-control">
							...
							<option value="1" <?php echo($filtros['estado']=='1')?'selected="selected"':''; ?>>Em bom estado</option>
					...
					<tbody>
						<?php foreach ($anuncios as $anuncio): ?>
							<tr>
								...
								<td>
									<a href="produto.php?id=<?php echo $anuncio['id']; ?>"><?php echo $anuncio['titulo']."<br/>"; ?></a>
